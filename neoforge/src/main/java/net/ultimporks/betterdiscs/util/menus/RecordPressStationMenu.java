...
public class RecordPressStationMenu extends AbstractContainerMenu {
    public final RecordPressBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public RecordPressStationMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.RECORD_PRESS.get());
    }
