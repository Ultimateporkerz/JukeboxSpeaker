package src.main.java.net.ultimporks.betterdiscs.compat;
...
public class JEIBetterDiscsPlugin implements IModPlugin {
    ...
    public void registerRecipeCatalysts(IRecipeCatalystRegistration registration) {
        registration.addRecipeCatalyst(new ItemStack(ModBlocks.RECORD_PRESS.get().asItem()),
                RecordPressCategory.RECORD_PRESS_RECIPE_TYPE);

        registration.addRecipeCatalyst(new ItemStack(ModBlocks.RECORD_LATHE.get().asItem()),
                RecordLatheCategory.RECORD_LATHE_RECIPE_TYPE);
    }
}
